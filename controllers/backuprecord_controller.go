...
// +kubebuilder:rbac:groups=backup.yourcompany.com,resources=backuprecords,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.yourcompany.com,resources=backuprecords/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=backup.yourcompany.com,resources=backuptasks,verbs=get;list;watch
...
func (r *BackupRecordReconciler) reconcileBackupRecord(ctx context.Context, backupRecord *backupv1alpha1.BackupTask) (ctrl.Result, error) {
...
func (r *BackupRecordReconciler) updateBackupStatistics(ctx context.Context, backupRecord *backupv1alpha1.BackupRecord, job *batchv1.Job) error {
	...
	// 从Pod的注解中获取统计信息
	if statsStr, ok := pod.Annotations["backup.yourcompany.com/statistics"]; ok {
		// 这里可以解析JSON格式的统计信息
		// 简化处理，只记录Pod信息
